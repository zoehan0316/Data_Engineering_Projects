...
def process_song_file(cur, filepath):
    ...
    Parameters:
    -cur: the cursor object that allows Python to execute PostgreSQL commands in a database session
...
def main():
    '''
    Build ETL Pipeline for Sparkify song play data. Cursor object to process sql queries and process the song and log data
    '''
